...
import static com.example.anikrakib.covid19.R.*;
...
public class CovidCountryAdapter extends RecyclerView.Adapter<CovidCountryAdapter.ViewHolder> implements Filterable {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            tvTotalCases = itemView.findViewById(id.tvTotalCases);
            tvCountryName = itemView.findViewById(id.tvCountryName);
            imgCountryFlag = itemView.findViewById(id.imgCountryFlag);
        }
    }
